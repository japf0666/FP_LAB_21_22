...
public class Teclado {
	...
	public static final int 	INT_ERR 	=	Integer.MAX_VALUE;
        public static final long  	LONG_ERR 	= 	Long.MAX_VALUE;
	...
	/** 
	 *  Método que lee una línea de teclado y devuelve el <code><b>long</b></code> escrito por el usuario. 
	 *  @return Devuelve el <code><b>long</b></code> introducido por el usuario o <code><b>Teclado.INT_ERR</b></code> si no se introdujo un byte.
	 */
	public static long readLong () {
		long val=LONG_ERR;
		try	{
			BufferedReader in = new BufferedReader (new InputStreamReader (System.in));
			val = Long.parseLong (in.readLine());
		} catch (IOException ioe) {
			System.out.println (">> Excepción (readLnLong): Imposible leer línea");
		} catch (NumberFormatException nfe) {
			System.out.println (">> Excepción (readLnLong): Valor introducido no long");
		} catch (Exception e) {
			System.out.println (">> Excepción (readLnLong): Ocurrió una excepción");
		}
		return val;
	}
